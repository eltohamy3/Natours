...
exports.updateUserData = "".concat(apiLink, "/users/updateMe"); // patch
...
var updateUserData = exports.updateUserData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email) {
    var res, errorMessage, _err$response, _errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch(_apiLink.default.updateUserData, {
            name: name,
            email: email
          });
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            errorMessage = res.message || "Update your data failed. Try again.";
            (0, _alerts.showAlert)("error", errorMessage);
          }
          _context.next = 13;
          break;
        case 8:
          ...
          // Ensure 'err.response' and 'err.response.data' exist before accessing properties
          _errorMessage = ((_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || "Update your data failed. Try again.";
...
},{"axios":"../../node_modules/axios/index.js","./../../constant/apiLink":"../../constant/apiLink.js","../../utils/appError":"../../utils/appError.js","./alerts":"alerts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
