...
exports.signup = "".concat(apiLink, "/users/signup");
exports.logout = "".concat(apiLink, "/users/logout");
exports.CheckOutSession = "".concat(apiLink, "/bookings/checkout-session"); // then we will specify the tour id 

exports.updateUserData = "".concat(apiLink, "/users/updateMe"); // patch for update name and email only 
exports.updateUserPassword = "".concat(apiLink, "/users/updateMyPassword"); // patch for update name and email only
...
exports.logout = exports.loginOrSingup = void 0;
var _alerts = require("./alerts");
var _axios = _interopRequireDefault(require("axios"));
var _apiLink = _interopRequireDefault(require("./../../constant/apiLink"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
var loginOrSingup = exports.loginOrSingup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var res, _res$data, errorMsg, _err$response, errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post(type === 'login' ? _apiLink.default.login : _apiLink.default.signup, data);
        case 3:
          res = _context.sent;
          console.log(res); // Debugging: Print the response

          if (res.data && res.data.status === "success") {
            (0, _alerts.showAlert)("success", "".concat(type === 'login' ? "Login" : "Signup", " Successfully!"));
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          } else {
            // Fallback message if 'res.data.message' is missing
            errorMsg = ((_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.message) || "An unexpected error occurred.";
        ...
        case 8:
          ...
          console.error(_context.t0); // Debugging: Print full error object

          // Ensure 'err.response' and 'err.response.data' exist before accessing properties
          errorMessage = ((_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || "".concat(type === 'login' ? "Login" : "Signup", " failed. Try again.");
  ...
  return function loginOrSingup(_x, _x2) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get(_apiLink.default.logout);
        case 3:
          res = _context2.sent;
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js","./../../constant/apiLink":"../../constant/apiLink.js"}],"googleMap.js":[function(require,module,exports) {
"use strict";
...
var initMap = exports.initMap = function initMap() {
  ...
  locations.forEach(function (location) {
    ...
    var infoWindow = new google.maps.InfoWindow({
      content: "<h3>".concat(location.description, "</h3>")
    });
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe("pk_test_51QuvXeLRU3knGUpu6yQV8h3nrNmm2mX35OgIWMbnR6LxySYCYKM9RggZoAdKVvtFnIZODORWHgqSeh2aequHNm3J00yLhT6Vrg");
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var url, session, _err$response, errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // 1) get the session from the api
          url = "".concat(_apiLink.default.CheckOutSession, "/").concat(tourId);
          console.log(url);
          _context.next = 5;
        ...
        case 11:
          ...
          // Ensure 'err.response' and 'err.response.data' exist before accessing properties
          errorMessage = ((_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || "Booking failed. Try again.";
          (0, _alerts.showAlert)("error", errorMessage);
        case 16:
        case "end":
          return _context.stop();
...
},{"axios":"../../node_modules/axios/index.js","./../../constant/apiLink":"../../constant/apiLink.js","./alerts":"alerts.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var _res, errorMessage, _errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          type = type.toLowerCase();
          _context.next = 4;
          return _axios.default.patch(type === 'password' ? _apiLink.default.updateUserPassword : _apiLink.default.updateUserData, data);
        case 4:
          _res = _context.sent;
          console.log(_res);
        ...
        case 9:
          ...
          // Ensure 'err.response' and 'err.response.data' exist before accessing properties
          _errorMessage = res.message || "Update your ".concat(type == 'password' ? "Password" : "Data", " failed. Try again.");
          (0, _alerts.showAlert)("error", _errorMessage);
        case 14:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./../../constant/apiLink":"../../constant/apiLink.js","./alerts":"alerts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
var BookingNowBtn = document.getElementById('book-tour');
// values
...
document.addEventListener("DOMContentLoaded", function () {
  if (document.getElementById("map")) {
    window.initMap = _googleMap.initMap; // Make sure Google Maps API can call this function
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var oldPassword, newPassword, newConfirmPassword;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
...
if (BookingNowBtn) {
  BookingNowBtn.addEventListener("click", /*#__PURE__*/function () {
